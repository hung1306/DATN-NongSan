    ...
    <div className="h-screen flex flex-col">
        ...
        <div className=" bg-ebffeb px-10 py-3">
            ...
            <div className="bg-white flex items-center justify-center flex-col mt-5 ml-40 mr-40 py-5 rounded-xl">
                ...
                <p className="text-center mt-2">Chúc mừng bạn đã trở thành nhà cung cấp của AgriMart</p>

                <div className="flex justify-center w-full mt-10">
                    <button className="bg-primary text-white py-2 px-4 rounded-md">Hoàn Thành</button>
                </div>
            </div>
