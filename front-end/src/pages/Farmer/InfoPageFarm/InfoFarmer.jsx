...
export default function InfoFarmer() {
  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      <div className="relative">
        ...
        <div
          className={`flex-grow flex flex-row justify-center items-center ${
            showNav ? "ml-64" : ""
          }`}
        >
          <div className="bg-white p-4 rounded-lg shadow-md w-full max-w-4xl flex justify-between">
            <div className="w-1/2 pr-4">
              ...
              <div className="flex justify-end w-full">
                <button
                  className="bg-primary text-white py-2 px-4 rounded-md mb-4"
            ...
            <div className="w-1/2 pl-4 border-l border-gray-300">
              <div className="flex flex-col items-center">
                <img
                  src="/src/assets/avata_img/avata.png"
                  alt="Avatar"
